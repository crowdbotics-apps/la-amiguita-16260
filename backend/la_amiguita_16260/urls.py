"""la_amiguita_16260 URL Configuration
...
admin.site.site_header = "LA AMIGUITA"
admin.site.site_title = "LA AMIGUITA Admin Portal"
admin.site.index_title = "LA AMIGUITA Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="LA AMIGUITA API",
        default_version="v1",
        description="API documentation for LA AMIGUITA App",
    ),
    public=True,
